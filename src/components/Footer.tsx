  ...
  return (
    <footer className="relative z-20 text-white py-10 sm:py-14 px-4 sm:px-6 md:px-10 lg:px-12 font-sans select-none overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto w-full relative z-10 flex flex-col gap-8 sm:gap-10">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <button
                  ...
                  className="touch-target px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/30 text-white font-semibold text-xs sm:text-sm shadow-md backdrop-blur-md hover:scale-105 transition-all ml-1 sm:ml-2 cursor-pointer"
                >
                  Start a Project ↗
                </button>
              </div>
        ...
        {/* ========================================================================= */}
        {/* COPYRIGHT & PRIMARY HIGH-VISIBILITY BACK TO TOP BUTTON                    */}
        {/* ========================================================================= */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-white/80">
          ...
          >
            ...
            <span className="font-bold">&uarr;</span>
          </button>
        </div>

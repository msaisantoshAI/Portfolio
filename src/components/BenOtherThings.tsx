...
const apps: AppItem[] = [
  {
    ...
    tags: ['Generative UI', 'Agent Trees', 'Human-in-the-Loop', 'Cursor & Claude'],
  },
  {
    id: 'design-system',
    name: 'Enterprise Design System',
    category: 'Design Systems & Tokens',
    tagline: 'Scalable icon libraries & WCAG 2.2 AA interaction states',
    description: 'A comprehensive multi-theme component library built with scalable design tokens, WCAG 2.2 AA accessibility standards, and multi-state interactive specs.',
    tags: ['Design Tokens', 'WCAG 2.2 AA', 'Figma Libraries', 'Interaction States'],
  },
  {
    id: 'notion-systems',
    name: 'Heuristic UX Audit Engine',
    category: 'UX Research & Diagnostics',
    tagline: 'Usability gap identification & workflow efficiency matrix',
    description: 'A structured evaluation framework for auditing complex enterprise customer platforms, reducing recurring application issues, and optimizing estimation flows.',
    tags: ['Heuristic Evaluation', 'UX Audits', 'Stakeholder Alignment', 'Workflow Mapping'],
  },
  {
    id: 'creative-canvas',
    name: 'Visual Fine Arts Foundation',
    category: 'Visual Communication & Graphics',
    tagline: 'BFA Applied Art background applied to digital craft',
    description: 'Bringing classical visual composition, typography, color harmony, and fine arts discipline into modern digital product design and design systems.',
    tags: ['Visual Design', 'Applied Art', 'Typography', 'Adobe Creative Cloud'],
  },
];
...
const processPillars = [
  {
    step: '01',
    title: 'Heuristics & Discovery',
    focus: 'UX Audits, Usability Gaps & User Feedback',
    tools: ['Heuristic Evaluations', 'UX Audits', 'User Interviews', 'Analytics'],
  },
  {
    step: '02',
    title: 'Structure & IA',
    focus: 'Information Architecture & Workflow Mapping',
    tools: ['Miro', 'Notion', 'Confluence', 'Balsamiq'],
  },
  {
    step: '03',
    title: 'Design & Systems',
    focus: 'Scalable Icon Libraries & WCAG Accessibility',
    tools: ['Figma', 'Adobe CC (PS/AI/XD)', 'WCAG 2.2 AA', 'Design Tokens'],
  },
  {
    step: '04',
    title: 'AI Prototyping',
    focus: 'Generative AI Tools & Code-Level Validation',
    tools: ['Framer', 'Cursor', 'Lovable', 'Antigravity', 'Claude / Gemini'],
  },
  {
    step: '05',
    title: 'Delivery & Metrics',
    focus: 'Cross-Functional Collaboration & Issue Reduction',
    tools: ['Jira', 'Agile UX', 'Usability Metrics', 'Cross-Functional Sync'],
  },
];
      ...
      <div className="rounded-[28px] bg-white/88 dark:bg-[#081026]/88 border border-white/60 dark:border-white/10 p-7 sm:p-10 md:p-14 shadow-[0_16px_45px_rgba(20,60,140,0.12)] dark:shadow-[0_16px_45px_rgba(0,0,0,0.6)] backdrop-blur-2xl space-y-12 transition-colors duration-300">
        ...
        <div className="space-y-3">
          <p className="eyebrow text-blue-600 dark:text-blue-400">
            Process &amp; AI-UX Arsenal
          </p>
          <h2 className="section-heading text-zinc-900 dark:text-white">
            How I Work &amp; Build
          </h2>
          <p className="body-lead text-zinc-600 dark:text-zinc-400">
            Blending classical fine arts and heuristic research with modern AI assistants, rapid prototyping, and scalable enterprise design systems.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-mono uppercase tracking-widest text-zinc-500 dark:text-zinc-400 font-semibold">
            The 5-Stage Product &amp; AI-UX Lifecycle
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
            {processPillars.map((p, idx) => (
              <div
                key={idx}
                className="p-5 rounded-2xl bg-zinc-50/80 dark:bg-white/5 border border-black/5 dark:border-white/10 space-y-3 flex flex-col justify-between shadow-sm"
              >
        ...
        {/* Featured Interactive App Card Container */}
        <div className="rounded-3xl border border-black/5 dark:border-white/10 bg-zinc-50/80 dark:bg-black/50 overflow-hidden shadow-sm p-6 sm:p-10 relative">
          <div className="flex flex-col lg:flex-row items-stretch gap-8">
            ...
            <div className="flex-1 flex flex-col justify-between space-y-6">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-zinc-500 dark:text-zinc-400 font-mono">
                    Focus {activeAppIndex + 1} of {apps.length}
                  </span>
                </div>
              ...
              <div className="space-y-4 pt-4 border-t border-black/5 dark:border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="caption-meta text-zinc-500 font-mono">Click tabs below to inspect</span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[46%] h-[240px] sm:h-[300px] relative rounded-2xl overflow-hidden border border-black/10 dark:border-white/10 bg-zinc-900 flex items-center justify-center p-6 group">
              <Image
                ...
                alt="Product Design and Architecture Whiteboard Sessions"
                fill

    ...
    <section id="contact" className="px-4 py-10 sm:py-14 sm:px-8 md:px-12 max-w-[1440px] mx-auto w-full font-sans">
      <div className="rounded-[32px] bg-white dark:bg-[#28282B] border border-black/10 dark:border-white/12 p-6 sm:p-10 md:p-14 shadow-sm dark:shadow-md backdrop-blur-2xl space-y-8 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch pt-2">
          ...
          <div className="lg:col-span-6 rounded-2xl bg-zinc-100 dark:bg-[#333338]/60 p-6 sm:p-8 text-zinc-900 dark:text-white shadow-xs relative overflow-hidden flex flex-col justify-between border border-black/10 dark:border-white/15">
            ...
            <div className="pt-5 border-t border-black/10 dark:border-white/10 flex items-center justify-between mt-4">
          ...
          <div className="lg:col-span-6 rounded-2xl border border-black/10 dark:border-white/10 bg-zinc-50/90 dark:bg-[#333338]/60 p-6 sm:p-8 flex flex-col justify-between space-y-5 shadow-xs">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#28282B] text-zinc-950 dark:text-white text-xs sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-zinc-900 dark:focus:ring-white transition-all placeholder:text-zinc-400"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#28282B] text-zinc-950 dark:text-white text-xs sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-zinc-900 dark:focus:ring-white transition-all placeholder:text-zinc-400 resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="touch-target w-full flex items-center justify-center px-5 py-2.5 rounded-xl bg-zinc-950 hover:bg-zinc-800 text-white dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 font-bold text-xs sm:text-sm shadow-xs transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="pt-3 border-t border-black/5 dark:border-white/10 flex flex-wrap items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">

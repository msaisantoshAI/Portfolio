    ...
    <section id="contact" className="px-5 py-16 md:px-8 lg:px-24 max-w-[1280px] mx-auto w-full">
      <div className="rounded-[28px] bg-zinc-900/80 border border-white/10 p-8 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.4)] backdrop-blur-xl space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch pt-4">
          ...
          <div className="lg:col-span-6 rounded-3xl border border-white/10 bg-black/50 p-8 sm:p-10 flex flex-col justify-between space-y-8 shadow-xl">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a
                  ...
                  className="flex items-center gap-3 p-4 rounded-2xl bg-white text-black font-semibold text-sm hover:bg-zinc-200 transition-all shadow-md active:scale-95"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 p-4 rounded-2xl bg-white/10 border border-white/15 text-white font-semibold text-sm hover:bg-white/20 hover:border-blue-400/50 transition-all shadow-md active:scale-95"
                >
              ...
              {isSubmitted ? (
                <div className="p-6 rounded-2xl bg-blue-500/10 border border-blue-500/30 text-center space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">If your mail app didn&apos;t open automatically, write directly to Saisantoshmadhari@gmail.com</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-3 pt-2">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-zinc-500 text-sm focus:outline-none focus:border-blue-500 transition-colors"
                  />
                  <input
                    type="email"
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-zinc-500 text-sm focus:outline-none focus:border-blue-500 transition-colors resize-none"
                  />
                  <button
                    type="submit"

          ...
          <div className="lg:col-span-7 rounded-2xl border border-black/10 dark:border-white/10 bg-zinc-50 dark:bg-[#18181B] p-6 sm:p-8 space-y-5 shadow-sm flex flex-col justify-between">
            <div className="space-y-2.5 border-b border-black/5 dark:border-white/10 pb-4">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-[11px] font-mono bg-black/5 dark:bg-white/10 text-zinc-900 dark:text-white px-3 py-0.5 rounded-full border border-black/10 dark:border-white/15 font-bold">
                  Enterprise SaaS
                </span>
              </div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-zinc-700 dark:text-zinc-300">
              {tcsBullets.map((bullet, idx) => (
                <li key={idx} className="flex items-start gap-2.5 leading-relaxed">
                  <span className="text-zinc-950 dark:text-white mt-0.5 shrink-0 font-bold text-sm">&bull;</span>
                  <span>{bullet}</span>
                </li>
              ))}
            </ul>

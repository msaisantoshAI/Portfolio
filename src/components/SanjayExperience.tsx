        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 rounded-2xl border border-black/10 dark:border-white/10 bg-zinc-50 dark:bg-[#18181B] p-6 sm:p-8 space-y-5 shadow-sm flex flex-col justify-between">
            <div className="space-y-2.5 border-b border-black/5 dark:border-white/10 pb-4">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-[11px] font-mono bg-blue-50 dark:bg-blue-950/70 text-blue-600 dark:text-blue-400 px-3 py-0.5 rounded-full border border-blue-200 dark:border-blue-800/60 font-bold">
                  Enterprise SaaS
                </span>
              </div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-4">
            {highlights.map((item, idx) => (
              <div 
                key={idx} 
                className="flex-1 p-5 rounded-2xl bg-zinc-50 dark:bg-[#18181B] border border-black/10 dark:border-white/10 flex flex-col justify-center space-y-1 shadow-sm hover:border-blue-600/40 dark:hover:border-blue-400/40 transition-all"
              >

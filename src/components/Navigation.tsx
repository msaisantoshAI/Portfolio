        ...
        <div className="mx-auto flex w-full max-w-[1300px] items-center justify-between gap-4 pointer-events-auto">
              ...
              {navLinks.map((item) => {
                ...
                return (
                  <a
                    key={item.id}
                    href={item.href}
                    className={`relative px-4 py-2 text-sm font-medium transition-colors duration-200 rounded-full focus-visible:ring-2 focus-visible:ring-blue-500 whitespace-nowrap ${
                  ...
                  >
                    {isActive && (
                      <motion.span
                        ...
                        className="absolute inset-0 bg-blue-600 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.6)] -z-10"
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
            ...
            <a 
              ...
              className="touch-target inline-flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#0a0f1d]/90 hover:bg-[#15203d] border border-white/25 hover:border-white/45 text-white hover:text-blue-400 hover:scale-105 active:scale-95 transition-all shadow-lg backdrop-blur-md shrink-0 focus-visible:ring-2 focus-visible:ring-blue-500"
            >
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="h-4 w-4 sm:h-4.5 sm:w-4.5" aria-hidden="true">
            ...
            {navLinks.map((item) => {
              ...
              return (
                <a
                  key={item.id}
                  href={item.href}
                  className={`touch-target relative px-3 py-1.5 text-xs font-medium transition-colors duration-200 rounded-full focus-visible:ring-2 focus-visible:ring-blue-500 whitespace-nowrap ${

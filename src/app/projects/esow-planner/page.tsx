...
export default function EsowPlannerCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#28282B] text-zinc-900 dark:text-zinc-100 font-sans transition-colors duration-300">
      
      {/* Top Fixed Header with Back Link & Project Meta */}
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-[#28282B]/85 backdrop-blur-2xl border-b border-black/5 dark:border-white/10 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <Link
          href="/#work"
          className="touch-target inline-flex items-center px-3.5 py-1.5 rounded-full bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 text-zinc-900 dark:text-white font-medium text-xs transition-all hover:scale-105"
        >
          Back to Portfolio
        </Link>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-12 pt-24 pb-20">
        ...
        <div className="mb-10 sm:mb-14 rounded-3xl bg-white dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 md:p-14 shadow-lg backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 items-start relative">
          ...
          {/* ========================================================================= */}
          <aside className="hidden lg:block w-64 xl:w-72 shrink-0 sticky top-24 self-start rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-5 shadow-md backdrop-blur-2xl">
          ...
          <main className="flex-1 w-full space-y-10 sm:space-y-12">
            ...
            <section id="overview" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
            ...
            <section id="situation" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  02 · Situation (S)
                </span>
            ...
            {/* 03. TASK & MANDATE */}
            <section id="task" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  03 · Task &amp; Mandate (T)
                </span>
            ...
            <section id="discovery" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  04 · Discovery &amp; Research
                </span>
            ...
            {/* 05. DEFINE & PERSONAS */}
            <section id="define" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  05 · Define &amp; Personas
                </span>
            ...
            {/* 06. STRATEGY & ROADMAP */}
            <section id="strategy" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  06 · Strategy &amp; Roadmap
                </span>
            ...
            <section id="ia" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  07 · Information Architecture
                </span>
            ...
            <section id="ui-design" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
            ...
            <section id="tradeoffs" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
            ...
            <section id="validation" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
                  10 · Usability Validation
                </span>
            ...
            <section id="impact" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
            ...
            <section id="reflection" className="rounded-3xl bg-white/95 dark:bg-[#28282B] border border-black/10 dark:border-white/15 p-6 sm:p-10 shadow-sm backdrop-blur-xl space-y-6">
              <div className="space-y-1 border-b border-black/5 dark:border-white/10 pb-4">
                <span className="text-xs font-mono font-bold text-zinc-950 dark:text-white uppercase tracking-widest">
